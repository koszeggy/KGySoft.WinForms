    ...
    internal sealed class NativeTaskDialog : ITaskDialog
    {
        ...
        private void Dispose(bool disposing)
        {
            ...
            if (dialogState != TaskDialogStates.Closed)
            {
                ...
                while (dialogState != TaskDialogStates.Closed)
                {
                    Thread.Sleep(10);
                }
            }
            ...
            try
            {
                switch (uNotification)
                {
                    ...
                    case TASKDIALOG_NOTIFICATIONS.TDN_BUTTON_CLICKED:
                        ...
                        bool isClosing = dialogState == TaskDialogStates.Closing;
                        if (!isClosing)
                        {
                        ...
                        if (isClosing)
                        {
                            ...
                            dialogState = isClosing ? TaskDialogStates.Closing : TaskDialogStates.Showing;
                        }
