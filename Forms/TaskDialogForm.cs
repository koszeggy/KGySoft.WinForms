...
namespace KGySoft.Controls
{
    ...
    internal sealed partial class TaskDialogForm : BaseForm, ITaskDialog
    {
        ...
        private TaskDialogStates dialogState = TaskDialogStates.Initializing;
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            if (dialogState != TaskDialogStates.Closed)
            {
                isForcedClosing = true;
                dialogState = TaskDialogStates.Closed;
            }
        ...
        protected override void OnHandleDestroyed(EventArgs e)
        {
            ...
            if (dialogState == TaskDialogStates.Showing)
            {
        ...
        private void ResetSettings()
        {
            ...
            HyperlinkResolveModes resolve = useLinks ? HyperlinkResolveModes.ResolveHrefsOnly : HyperlinkResolveModes.None;
            ...
            try
            {
                ...
                if (cfg.HasMainControls)
                {
                    ...
                    else
                    {
                        ...
                        if (dialogState != TaskDialogStates.Initializing)
                ...
                if (dialogState != TaskDialogStates.Initializing && !pnlDividerFooterBottom.Visible && cfg.HasFooter && cfg.IsDetailsVisibleInFooter)
                    Height += pnlDividerFooterBottom.Height;
                pnlDividerFooterBottom.Visible = cfg.HasFooter && cfg.IsDetailsVisibleInFooter;

                // prevent scrollbar flickering
                if (dialogState != TaskDialogStates.Initializing && !pnlDividerDetailsFooterTop.Visible && cfg.IsDetailsVisibleInFooter)
                    Height += pnlDividerDetailsFooterTop.Height;
                pnlDividerDetailsFooterTop.Visible = cfg.IsDetailsVisibleInFooter;

                // prevent scrollbar flickering
                if (dialogState != TaskDialogStates.Initializing && !lblDetailsFooter.Visible && cfg.IsDetailsVisibleInFooter)
        ...
        {
            dialogState = TaskDialogStates.Showing;
            switch (host.Icon)
            {
                case TaskDialogStandardIcons.Information:
        ...
        void TaskDialogForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (e.CloseReason == CloseReason.UserClosing)
            {
                ...
                dialogState = args.Cancel ? TaskDialogStates.Showing : TaskDialogStates.Closing;
                if (args.Cancel)
                    selectedCustomButtonIndex = -1;
            }
            ...
            {
                isForcedClosing = true;
                dialogState = TaskDialogStates.Closing;
            }
        }
        ...
        void btnShowHideDetails_ExpandedChanged(object sender, EventArgs e)
        {
            ...
            if ((host.Options & TaskDialogOptions.ExpandFooterArea) == TaskDialogOptions.None)
            {
                ...
                try
                {
                    ...
                    lblDetailsMain.FadingAnimationOptions = FadingOptions.StandardEffects;
                    if (isDetailsExpanded && dialogState != TaskDialogStates.Initializing)
        ...
        {
            if (dialogState == TaskDialogStates.Initializing || isCheckboxChecking)
                return;
        ...
        TaskDialogStates ITaskDialog.ShowState
        {
        ...
        {
            if (dialogState == TaskDialogStates.Initializing || dialogState == TaskDialogStates.Closed)
            {
