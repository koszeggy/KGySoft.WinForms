...
{
    internal partial class LocalizationExample : ControlsTestBaseForm
    {
        #region Fields
        ...
        protected override void OnFormClosing(FormClosingEventArgs e)
        {
            ...
            // the reopening in the parent form. See EditResourcesExample for an example.
            if (isRtlChanging)
            {
                e.Cancel = true;
        ...
        private void OnEditResourcesCommand()
        {
            ...
            using var frmEditResources = new EditResourcesExample(vmEdit);
            do
            {
