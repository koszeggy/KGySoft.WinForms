...
{
    internal partial class MdiChildForm : BaseForm
    {
        #region Fields

        private readonly Action<string> writeLog = null!;
        private readonly Size referenceSize = new(275, 100);
        ...
        internal MdiChildForm(Action<string> writeLog) : this() => this.writeLog = writeLog;
        ...
        {
            var child = new MdiChildForm(writeLog) { Text = @"Normal Child " + (MdiParent!.MdiChildren.Length + 1) };
            ShowMdiChild(child);
        ...
        {
            var child = new MdiChildForm(writeLog) { Text = @"Dialog Child " + (MdiParent!.MdiChildren.Length + 1) };
