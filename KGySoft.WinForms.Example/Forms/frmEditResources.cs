...
{
    internal partial class frmEditResources : DialogBaseForm
    {
        #region Constants
        ...
        internal frmEditResources(EditResourcesViewModel viewModel)
            : this()
        {
        ...
        protected override void ApplyStringResources()
        {
            ...
            Text = LocalizationHelper.GetString(resTextFormat, customLocalizationContext, viewModel.EditedLanguage.NativeName, viewModel.EditedLanguage.EnglishName);
        }
