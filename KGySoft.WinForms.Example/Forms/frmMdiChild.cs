...
namespace KGySoft.WinForms.Example.Forms
{
    internal partial class frmMdiChild : BaseForm
    {
        ...
        private void InitCommandBindings()
        {
            ...
            CommandBindings.Add(OnOpenChildAsDialog).AddSource(miOpenChildAsDialog, nameof(miOpenChildAsDialog.Click));
        ...
        private void ResetStatus()
        {
            lblStatus.Text = IsSuspended
                ...
                : $"This child is active{Environment.NewLine}When focused, use the '{Text}' menu to open new new children.";
