/* Common base of user controls containing textboxes
 * 
 * Common tasks should be placed here, such as
 * ReadOnly, ResetMarks, ExitChange event general handling, etc.
 * 
 * In descendants MainControl must be overridden and a new TextBox property must be introduced
 * that returns the actual TextBoxBase instance
 * 
 */
...
namespace KGySoft.WinForms.Controls
{
	...
	public partial class ucTextBase: ucCaptionedBase
	{
		...
		#region ucTextBase property-k

		// TODO: consider delete this property
		/// <summary>
