...
{
    /// <summary>
    /// Provides WinForms-specific extension methods for the <see cref="IReadWriteBitmapData"/> type. This class contains essentially the same text-drawing extension methods as
    ...
    /// class, but the methods in this class expect a WinForms-specific <see cref="TextFormatFlags"/>&#160;<see langword="enum"/> instead of a disposable <see cref="StringFormat"/> instance.
    /// </summary>
    public static class WinFormsBitmapDataExtensions
    {
        ...
        /// and <see cref="O:KGySoft.Drawing.Imaging.WinFormsBitmapDataExtensions.DrawTextOutline">DrawTextOutline</see> consecutively, you can achieve a better performance by creating a <see cref="Path"/> once, and then calling
        ...
        /// and <see cref="O:KGySoft.Drawing.Imaging.WinFormsBitmapDataExtensions.BeginDrawTextOutline">BeginDrawTextOutline</see> consecutively, you can achieve a better performance by creating a <see cref="Path"/> once, and then calling
        ...
        /// and <see cref="O:KGySoft.Drawing.Imaging.WinFormsBitmapDataExtensions.DrawTextOutlineAsync">DrawTextOutlineAsync</see> consecutively, you can achieve a better performance by creating a <see cref="Path"/> once, and then calling
