...
{
    /// <summary>
    /// The <c>KGySoft.WinForms</c> namespace contains some general, WinForms-specific types, extensions and helper classes that
    /// can be used in a Windows Forms application. It is also the container of the <see cref="N:KGySoft.WinForms.Components"/>,
