...
{
    /// <summary>
    /// Represents the <c>KGySoft.WinForms</c> module.
    ...
    public static class WinFormsModule
    {
        ...
        /// <summary>
        /// Initializes the <c>KGySoft.WinForms</c> module (and also the <c>KGySoft.Drawing</c> module).
        ...
        /// the KGy SOFT WinForms Libraries in an application, and you want to configure resource management on starting the application via
        ...
        /// </remarks>
        /// <example>
        /// The following example demonstrates how to initialize the <c>KGySoft.WinForms</c> module in an application (you don't really need to do this
        /// if you use KGy SOFT WinForms Libraries from a class library):
        /// <code lang="C#"><![CDATA[
        /// using KGySoft;
        ...
        ///     {
        ///         // To make sure that configuring LanguageSettings affects also the resources in KGySoft.WinForms
        ///         WinFormsModule.Initialize();
        ///
