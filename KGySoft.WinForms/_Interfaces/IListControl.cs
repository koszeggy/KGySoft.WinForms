...
namespace KGySoft.WinForms
{
    ...
    {
        /// <summary>
        /// Gets whether the there is no selected item in the list control (<see cref="SelectedValue"/> is <see langword="null"/>, <see cref="DBNull"/> or equals with <see cref="ControlExtensions.NotSelectedValue"/>)
        /// </summary>
        bool IsEmpty { get; }
